      ...
      <main className="mx-auto max-w-2xl px-4 py-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 rounded-xl border border-gray-800 bg-gray-900/50 p-6">
          ...
          <p className="text-center text-xs text-gray-500">
            Responses generated by CyberShield Security Intelligence Engine. Enterprise and custom plan
            inquiries are routed to our sales team. For agency or referral partnerships, email{' '}
            <a href={`mailto:${SEO_PARTNERS_EMAIL}`} className="text-blue-400 hover:text-blue-300">
              {SEO_PARTNERS_EMAIL}
            </a>
