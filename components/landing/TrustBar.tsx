const metrics = [
  {
    ...
    sub: "Daily, hourly, or 5-min checks by plan",
    icon: (
  ...
  {
    label: "Email Alerts",
    sub: "SSL, domain, and change notifications",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    label: "Health Center",
    sub: "SSL, domain, uptime & alerts in one view",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    sub: "0–100 score — easy to understand",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
