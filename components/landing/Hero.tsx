        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <h1 className="mb-6 text-4xl font-bold leading-tight tracking-tight text-white sm:text-5xl lg:text-6xl">
              ...
              <span className="text-blue-400">Becomes Vulnerable.</span>
            </h1>

            <p className="mb-8 max-w-xl text-lg text-gray-400 leading-relaxed">
              CyberShield monitors your websites 24/7, detects security risks automatically,
              and alerts you before attackers do. No manual checks required.
            </p>
            ...
            <p className="mt-6 text-sm text-gray-500">
              Join developers and agencies protecting their web presence
            </p>
          </div>
          ...
          <div className="hidden lg:block">
            <div className="rounded-xl border border-gray-700/60 bg-gray-950 shadow-2xl shadow-black/40">
              ...
              <div className="p-5 font-mono text-sm leading-relaxed">
                ...
                <p className="mt-3 text-gray-600 animate-pulse">█</p>
              </div>
            </div>
          </div>
        </div>
